...
{
	AddDamageType("Taser",   '<bitmap:Add-Ons/Gamemode_CRPG/shapes/ci/CI_Taser> %1',    '%2 <bitmap:Add-Ons/Gamemode_CRPG/shapes/ci/CI_Taser> %1', 0.5, 1);
	
	datablock AudioProfile(taserExplosionSound)
	{
		filename	 = "Add-Ons/Gamemode_CRPG/sounds/radioWaveExplosion.wav";
	...
	datablock ItemData(taserItem)
	{
		...
		shapeFile = "Add-Ons/Gamemode_CRPG/shapes/Taser.dts";
		rotate = false;
		mass = 1;
		density = 0.2;
		elasticity = 0.2;
		...
		uiName = "Taser";
		iconName = "Add-Ons/Gamemode_CRPG/shapes/ItemIcons/Taser";
		doColorShift = false;
